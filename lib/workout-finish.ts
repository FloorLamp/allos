...
// (lib/notifications/dispatch-deadline.ts, and the pure fixture pins the hand-off) —
// but nothing carries it back to a caller, so no caller can act on it. That is a
// plumbing choice rather than an impossibility, and it is worth stating as one (#5194,
// eleventh pass corrected the absolute this comment used to make). The
