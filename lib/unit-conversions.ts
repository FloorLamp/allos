...
import { stripUcumUnitSyntax } from "./display-unit";
...
function aliasUnitTokens(s: string): string {
  // The matcher and the display vocabulary share UCUM stripping (#1018/#3493),
  // rather than carrying two copies that can drift.
  s = stripUcumUnitSyntax(s);
