...
// (lib/fitness-norms.json, generated by scripts/gen-fitness-norms.ts) — issue #158.
//
...
interface MarkerNorms {
  unit: string;
  direction: "higher_better";
  source: string;
  sexes: Record<"male" | "female", SexNorms>;
}
const MARKERS = (norms as { markers: Record<string, MarkerNorms> }).markers;
