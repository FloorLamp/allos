...
// biomarker detail page, keyed by the reading's canonical name (#482); the clinicalResultDetailHref
...
const LABS_DOMAIN: FollowUpDomain<LabFollowUpObservation> = {
  ...
  hrefFor: (r) => clinicalResultDetailHref(r.canonical_name, r.name),
};
