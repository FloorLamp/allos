...
//
// The combined form is around twenty fields, and that many always-empty boxes to
// collect the one or two readings someone actually took is the thing its own copy
// argues against ("fill in only what you measured"). They are disclosed in three groups,
...
export function measurementGroupSummary(
  ...
  if (group === "vitals") {
    ...
    // The window summarizes as ONE entry, like a blood pressure — and an em dash
