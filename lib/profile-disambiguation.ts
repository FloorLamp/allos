...
// identically in the profile switcher (and, with no photo, identical Avatar
// initials) — the switch itself is id-correct, but the
...
// profile switchers) are formatters over this one result so their labels can't drift.
