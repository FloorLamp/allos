...
describe("quick-range vocabulary (shared with the Timeline)", () => {
  ...
  describe("isCustomRange", () => {
    ...
    // A single-day window names no pill since the 1D pill retired (#4767), so it is
    // custom like any other hand-picked window.
    it("treats today alone as a custom window", () => {
