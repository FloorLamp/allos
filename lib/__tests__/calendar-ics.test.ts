...
describe("appointmentToIcsEvent — detail levels + timing", () => {
  const base: AppointmentLike = {
    id: 7,
    date: "2026-07-10", time_of_day: "14:30",
    status: "scheduled",
...
describe("selectFeedAppointments", () => {
  ...
  const appts: AppointmentLike[] = [
    {
      id: 1,
      date: "2026-07-20", time_of_day: null,
      status: "scheduled",
      title: null,
      location: null,
      provider_name: null,
    ...
    {
      id: 2,
      date: "2026-07-01", time_of_day: null,
      status: "scheduled",
      title: null,
      location: null,
      provider_name: null,
    ...
    {
      id: 3,
      date: "2026-01-01", time_of_day: null,
      status: "scheduled",
      title: null,
      location: null,
      provider_name: null,
    ...
    {
      id: 4,
      date: "2026-06-20", time_of_day: null,
      status: "completed",
      title: null,
      location: null,
      provider_name: null,
    ...
    {
      id: 5,
      date: "2026-07-05", time_of_day: null,
      status: "cancelled",
      title: null,
      location: null,
      provider_name: null,
...
describe("selectFeedPreviewRows — selection + projection composed", () => {
  ...
  it("drops completed/stale rows and projects the rest to preview rows", () => {
    const appts: AppointmentLike[] = [
      {
        id: 1,
        date: "2026-07-20", time_of_day: "09:00",
        status: "scheduled",
        title: "Physical",
        location: null,
        provider_name: null,
      ...
      appts: [
        {
          ...
          date: "2026-07-09", time_of_day: "09:00",
          status: "scheduled",
          title: "Dermatology",
          location: null,
...
describe("selectFeedAppointments — future horizon", () => {
  const appts: AppointmentLike[] = [
    ...
    {
      id: 2,
      date: "2026-09-01", time_of_day: null,
      status: "scheduled",
      title: null,
      location: null,
      provider_name: null,
...
describe("composeFeedEvents", () => {
  const appt: AppointmentLike = {
    id: 5,
    date: "2026-07-11", time_of_day: "14:30",
    status: "scheduled",
    title: "Cardiology",
    location: "Heart Center",
