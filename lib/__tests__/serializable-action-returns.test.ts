...
import type * as M98 from "@/app/(app)/nutrition/sensitivity-actions";
import type * as MOffer from "@/app/(app)/offer-actions";
...
type Census = {
  ...
  >;
  "app/(app)/nutrition/sensitivity-actions.ts": Expect<
    ActionsAreSerializable<typeof M98>
  >;
  "app/(app)/offer-actions.ts": Expect<ActionsAreSerializable<typeof MOffer>>;
...
const CENSUSED_MODULES = [
  ...
  "app/(app)/nutrition/sensitivity-actions.ts",
