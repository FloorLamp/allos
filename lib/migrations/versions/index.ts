...
import { migration as mSharedSupplyLastFill } from "./20260916-shared-supply-last-fill";
import { migration as mCarePlanMetricSampleLinks } from "./20260916-care-plan-metric-sample-links";
import { migration as mBreathingRateSleepSamples } from "./20260911-breathing-rate-sleep-samples";
import { migration as mFoodLogEventProperties } from "./20260922-food-log-event-properties";
...
export const MIGRATIONS: Migration[] = [
  ...
  mStoolEvents,
  mFoodSensitivities,
  mSharedSupplyLastFill,
  mCarePlanMetricSampleLinks,
  mBreathingRateSleepSamples,
  mFoodLogEventProperties,
];
