...
export default defineConfig({
  ...
  //
  // CI runs TWO workers per shard. The old `1` rested on a 2-core-runner
  // premise that is stale — `ubuntu-latest` gives public repos 4 cores — and the
  // repo's own back-to-back measurement on a 4-core container (the 48-spec slice
  // in docs/internals/e2e-hygiene.md) reads 11.1 min at one worker, 8.3 at two,
  ...
  // honest. PW_WORKERS still overrides for measurement.
