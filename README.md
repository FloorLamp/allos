...
- **Cycle** — a manual menstrual-cycle log under **Medical → Cycle**: one-tap "period started/ended" (or a dated form with flow and a note), per-day cycle symptoms (cramps, bloating, breast tenderness, … logged through the same symptom bar, led with the cycle context), the **derived phase** (menstrual/follicular/luteal) shown here and as a chip on the **Timeline** day view, and a **cycle-length + variability** trend answering "is it regular / changing." Deliberately tracking, not forecasting — no next-period or ovulation prediction and no fertility-awareness features; informational only, not medical advice
