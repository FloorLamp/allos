...
- **Upcoming** — one forward-looking list of everything due (doses, refills, appointments, planned & preventive care, immunizations, biomarker retests, goal deadlines, training targets, illness-care checks, condition-review suggestions), risk-stratified by your history and risk factors (and a recorded screening result — HPV, HIV, hepatitis — advances the matching screening's cadence, the way an immune titer advances a vaccine), snooze/dismissable — the same list feeds the Telegram digest and the calendar feed
