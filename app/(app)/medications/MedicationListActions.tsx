...
export default function MedicationListActions() {
  ...
  return (
    <div className="flex items-center gap-1 print:hidden">
      <Link
        href={PRINT_HREF}
        className="tap-target flex h-(--control-box) w-(--control-box) items-center justify-center rounded-lg border border-(--border) bg-surface text-slate-600 transition hover:bg-(--ghost-hover) hover:text-slate-900 dark:text-slate-300 dark:hover:text-slate-100"
