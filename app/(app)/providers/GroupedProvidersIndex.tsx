  ...
  return (
    <div>
      ...
      {showGrouped ? (
        <div className="space-y-6" data-testid="provider-directory-grouped">
          ...
          {otherCount > 0 ? (
            ...
            >
              <summary className="fold-control flex list-none items-center gap-2 text-sm font-medium text-slate-600 [&::-webkit-details-marker]:hidden dark:text-slate-300">
      ...
      {directory.archivedCount > 0 ? (
        ...
        >
          <summary className="fold-control flex items-center gap-2 px-4 text-sm font-medium text-slate-600 dark:text-slate-300">
