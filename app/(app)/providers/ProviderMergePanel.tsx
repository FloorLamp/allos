...
export default function ProviderMergePanel({
  ...
  return (
    ...
    >
      <summary className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-slate-600 outline-hidden transition hover:bg-slate-100 focus-visible:ring-2 focus-visible:ring-brand-500/40 dark:text-slate-300 dark:hover:bg-ink-800">
