  ...
  return (
    <div data-testid="trash-retention-settings" className="card space-y-4">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-400">
        ...
        row&apos;s full content <em>and</em> any video clips captured with it, so
        a longer window means deleted health data stays on this server longer —
        anyone can remove a row immediately with &ldquo;Delete
        permanently&rdquo;. Allowed range: {MIN_TRASH_RETENTION_DAYS}–
        {MAX_TRASH_RETENTION_DAYS} days.
      </p>
