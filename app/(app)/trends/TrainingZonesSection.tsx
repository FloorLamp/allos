            ...
            <>
              ...
              {includesToday &&
                ...
                data.zone2Target > 0 && (
                  ...
                  >
                    ...
                    {data.currentWeekZone2.minutes} of {data.zone2Target} min
                    target
              ...
              <div className="mt-5 border-t border-black/5 pt-4 dark:border-white/10">
                ...
                <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">
                  {model.formula} A lab-tested lactate/ventilatory threshold
                  beats any formula — set a max-HR override in{" "}
                  <Link
