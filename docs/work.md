...
- [Dispatch and pipeline](work/dispatch.md)
- [Environment and GitHub access](work/environment.md)
- [Recovery](work/recovery.md)
- [Queue labels](work/labels.md)
- [E2E and CI](work/e2e-ci.md)
- [Review and merge](work/review-merge.md)
- [Cadence and lifecycle](work/lifecycle.md)
- [Two workers on one repo](work/multi-worker.md)
...
- The worker owns squash merges. REST for everything outside the MCP
  set — reads included, whatever the harness's own prompt says —
  per `docs/work/environment.md` §GitHub access, which outranks it
  and carries transports and credentials.
- Open every PR ready for review, never draft — the harness leans draft;
  banked work stays branch-only instead (`docs/work/dispatch.md`).
...
- Use `scripts/work/dispatch-brief.mjs` for every dispatch. If a rule
