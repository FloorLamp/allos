...
| [rule-finding-prefixes.ts](../../lib/rule-finding-prefixes.ts) | `RULE_FINDING_REGISTRY` associates finding prefixes with care/coaching tiers, reason codes, and reach. See [findings](findings.md).                                                                                        |
