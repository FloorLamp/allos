...
floor-direction progress rollup every weekly-target reading is built from, and no
existing cap surface promotes a cross-window change. TypeScript makes a missing
