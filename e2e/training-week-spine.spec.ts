...
// #4079 RETIRED "What you did". The Overview card listed the week's sessions
// beside the band; the anti-drop census names it a RETIREMENT rather than a move —
// "duplicate of the Log mount's first screen, one tab away" — now that the Log
// renders the same rows through the shared history substrate. The band's own
// assertions (above) are untouched; what left is the fold that re-listed them.
