...
export async function expectDesktopRecordFormSubmit({
  form,
  actions,
  primaryOwner,
  submit,
...
export async function expectPhoneRecordFormSubmit({
  form,
  actions,
  primaryOwner,
  submit,
  ...
  fillsActions = false,
  name,
}: RecordFormActions & { adjacent?: Locator; fillsActions?: boolean }) {
