...
export default function MobileDetailPage({
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      className="fixed inset-0 z-50 flex flex-col bg-white pt-[env(safe-area-inset-top)] lg:hidden dark:bg-ink-900"
    >
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-black/5 py-2 pl-4 pr-2 dark:border-white/10">
        ...
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:text-slate-500 dark:hover:bg-ink-800 dark:hover:text-slate-300"
        >
