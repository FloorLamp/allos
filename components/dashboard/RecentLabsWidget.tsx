...
// Out-of-range (high/low/abnormal) reads as "bad"; a non-optimal read as "warn".
...
function flagLabel(flag: MedicalFlag): string {
  ...
  if (flag === "non-optimal") return "Non-optimal";
  return "Normal";
}
