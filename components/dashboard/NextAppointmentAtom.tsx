...
export interface NextAppointment {
  ...
  // else the visits list. Typed AppRoute so a dead route fails the build (#285).
  href: AppRoute;
}

// Next appointment atom (issue #171 — medical presence). Surfaces the single
// soonest scheduled visit so it isn't buried in the Upcoming list. Read-only.
export default function NextAppointmentAtom({
  appointment,
}: {
