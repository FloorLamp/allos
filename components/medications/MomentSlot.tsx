  ...
  return (
    ...
    >
      <summary
        ...
        className="fold-control flex list-none flex-wrap items-baseline gap-x-2 rounded-lg px-1 text-sm marker:content-none hover:bg-black/[0.03] dark:hover:bg-white/[0.04]"
      >
        <span
          aria-hidden
