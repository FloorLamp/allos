...
// by id; the combobox needs the strings in hand. ResultForm is nested (ClinicalResultsTable →
...
// `getRankedBiomarkerOptions`, so the two hosts (the Clinical results add slot / row editor,
