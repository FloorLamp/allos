...
// a stacked-section page such as `/records` becomes route-per-tab, an old
...
// `router.replace`s to it, PRESERVING any query string. Fires on mount (and whenever
// the hash changes); a no-op for
...
export default function AnchorRedirect({
  ...
  useEffect(() => {
    ...
    // Overview pane). Leave it for the
