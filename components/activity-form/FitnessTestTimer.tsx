...
export default function FitnessTestTimer({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-60 flex flex-col bg-surface p-5 sm:inset-8 sm:rounded-3xl sm:border sm:border-black/10 sm:shadow-2xl md:inset-x-[22%] md:inset-y-[12%] dark:sm:border-white/10"
    >
