...
function usage() {
  return (
    "usage: node scripts/work/post-merge-census.mjs <before-ref> [after-ref] [--run]\n" +
    "example: UX_SEED=1 node scripts/work/post-merge-census.mjs HEAD^ HEAD --run"
  );
}
