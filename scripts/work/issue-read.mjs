...
// worker labelled a fully-ruled P1 `needs-human`, then re-labelled #3265
...
// Reads need no credential of our own; see docs/work/environment.md.
function get(path) {
...
function readOne(n) {
  ...
  // to "how much of this is already done", and the worker's own release
