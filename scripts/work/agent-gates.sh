...
# so ordering stops being a memory item in every brief (docs/work.md).
#
...
#     scripts/work/ cannot change its outcome (#2954).
...
# types from it; `scripts/work/` is the one subtree the walk proves the
