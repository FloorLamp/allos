...
//
//   npx tsx scripts/work/reconcile-tracker.ts            # report to stdout
//   npx tsx scripts/work/reconcile-tracker.ts --json ev.json --out report.md
//   npx tsx scripts/work/reconcile-tracker.ts --issue 2603,2589
//
...
// `scripts/work/ci-watch.mjs` records).
import "../load-env";
