...
// a paragraph the worker remembered; this makes it a script it runs.
//
...
//      Where the worker and its lanes share ONE account (#4258), a
...
//
// Usage:
//   node scripts/work/merge-gate.mjs <pr-number> [--repo owner/name]
//     [--ignore-check <name>]
//
...
// Code remote container the worker actually runs in — measured on
...
//
// THE SHARED-IDENTITY CASE (#4258): the worker and every lane it
