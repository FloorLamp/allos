...
//
//   npx tsx scripts/work/reconcile-watermark.ts                # read
//   npx tsx scripts/work/reconcile-watermark.ts stamp \
//     --evidence /tmp/reconcile-evidence.json [--apply]                 # from a gather
//   npx tsx scripts/work/reconcile-watermark.ts stamp <iso> [--apply]
//
...
function carrierBody(iso: string): string {
  return [
    ...
    "`scripts/work/reconcile-tracker.ts` and advanced only by",
    "`scripts/work/reconcile-watermark.ts`. Do not edit by hand;",
