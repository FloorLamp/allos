...
//
//   npx tsx scripts/work/reconcile-labels.ts             # dry run + the domain worksheet
//   npx tsx scripts/work/reconcile-labels.ts --apply      # writes
//   npx tsx scripts/work/reconcile-labels.ts --plan p.json [--apply]
//
