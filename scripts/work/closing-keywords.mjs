...
// worker used on every merge of 2026-08-21/22.
//
...
//
// Usage:  node scripts/work/closing-keywords.mjs <pr-number>
...
function ghApi(endpoint, { paginate = false } = {}) {
  ...
  // issue-read.mjs. See docs/work/environment.md §GitHub access.
  if (run.error) {
