...
// ---- Label hygiene (docs/work/labels.md) --------------------------
//
...
/** Process markers with their own routing rules (docs/work/labels.md). */
 ...
 * (`RETIRED_LABELS`, `docs/work/labels.md`), so the label routes
