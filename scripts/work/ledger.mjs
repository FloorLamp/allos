...
// queue-snapshot.mjs and a python block in work-checkin.sh — and they
...
//
// Usage:
//   node scripts/work/ledger.mjs branches [file]   # active branches
//   node scripts/work/ledger.mjs e2e-count [file]  # active e2e lanes
//   node scripts/work/ledger.mjs issues [file]     # issues in flight
...
// CLI for work-checkin.sh, which cannot import a function. It answers
...
// worker to look. Printed as 0 it reads "no lanes are running", and an
